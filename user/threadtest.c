...
void exittest(void *arg1, void *arg2)
{
    int int1 = *(int *)arg1;
    int int2 = *(int *)arg2;
    res1 = int1;
...
void emptytest(void *arg1, void *arg2)
{
    // int i;
    int int1 = *(int *)arg1;
    int int2 = *(int *)arg2;
...
void stacktest(void *arg1, void *arg2)
{
    int int1 = *(int *)arg1;
    int int2 = *(int *)arg2;
    assert(int1 == 1);
...
void heaptest(void *arg1, void *arg2)
{
    int int1 = *(int *)arg1;
    int int2 = *(int *)arg2;
    assert(int1 == 1);
...
volatile int test7_canExit = 0;

void test7_thread(void *arg1, void *arg2)
{
    while (!test7_canExit)
    {
    }
...
// test7: large number of threads
int test7()
{
    for (int t = 0; t < NPROC - 3; t++)
    {
        int thread_pid = thread_create(test7_thread, 0, 0);
        assert(thread_pid > 0);
    }
    test7_canExit = 1;
    for (int t = 0; t < NPROC - 3; t++)
...
// test8: invoke test6 multiple times to check for appropriate cleanup
int test8()
{
    for (int i = 0; i < 5; i++)
    {
